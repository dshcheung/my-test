    ...
    const people = [
      {
        ...
        bio: `
        Karen Contet Farzam is passionate about Technology and Startups with a background in investment banking in JP Morgan.
      ...
      // {
      //   name: "Graham Milosevic",
      //   title: "Alchemist & CTO",
      //   image: 'http://angelhub.io/images/team/team_gram.jpg',
      //   link: 'https://www.linkedin.com/in/grahammilosevic/',
      //   bio: 'Graham has been developing for 17 years in various languages (Ruby, Python, Java, C#) and different domains.
