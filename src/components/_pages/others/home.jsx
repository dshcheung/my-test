          ...
          <Carousel controls={false}>
            <Carousel.Item>
              ...
              <Carousel.Caption>
                ...
                <div className="h4 fw-400 margin-top-5">| SFC Licensed Platform (Approval in Principal)</div>
              </Carousel.Caption>
            ...
            <Carousel.Item>
              ...
              <Carousel.Caption>
                ...
                <div className="h4 fw-400 margin-top-5 text-black">| SFC Licensed Platform (Approval in Principal)</div>
              </Carousel.Caption>
