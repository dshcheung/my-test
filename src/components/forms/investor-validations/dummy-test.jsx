      ...
      <div className={optClass}>
        <form onSubmit={handleSubmit}>
          ...
          <div className="help-text margin-bottom-50">
            As an SFC Licensed (Approval in Principal) firm, we are required to assess the risk appetite of all of our potential members, so please take the time to complete the following questionnaire. Thank you.
          </div>
