            ...
            <div className="row">
              <div className="col-xs-12">
                <div className="links">
                  ...
                  <div className="links-section">
                    <img className="img-responsive" src="/images/angelhub-logo-white-tagline.png" alt="AngelHub" />
                  </div>
                </div>
                <hr />
                <p className="text-white">
                  <strong className="fw-500">AngelHub is a (approval in principal) Securities and Futures Commission licensed platform</strong>.
